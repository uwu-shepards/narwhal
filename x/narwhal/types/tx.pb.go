...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_89294628107f4fc4, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_89294628107f4fc4, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "narwhal.narwhal.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "narwhal.narwhal.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("narwhal/narwhal/tx.proto", fileDescriptor_89294628107f4fc4) }

var fileDescriptor_89294628107f4fc4 = []byte{
	// 315 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xc8, 0x4b, 0x2c, 0x2a,
	0xcf, 0x48, 0xcc, 0xd1, 0x87, 0xd1, 0x25, 0x15, 0x7a, 0x05, 0x45, 0xf9, 0x25, 0xf9, 0x42, 0xfc,
	...
	0x00, 0xff, 0xff, 0x85, 0xd1, 0x4d, 0x6d, 0x24, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/narwhal.narwhal.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/narwhal.narwhal.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "narwhal.narwhal.Msg",
	...
	Metadata: "narwhal/narwhal/tx.proto",
}
